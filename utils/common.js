export const houseList = [
	...
	// 	permissions: ['mes:mespiecesmarket:cutInStorage', 'mes:mespiecesmarket:cutOutStorage',
	// 		'mes:mespiecesmarket:repealCutInStorage'
	// 	],
	// 	list: [{
	// 			title: '裁片入库',
	...
	//新包工
	{
		...
		media: ['small', 'middle'],
		backgroundColor: '#ecf8f3',
		permissions: ['mes:mesengineeringmanagement:workReport', 'mes:mesengineeringmanagement:workGroupReport',
			'mes:mesengineeringmanagement:selectReportRecord'
		],
		list: [{
				title: "个人按包报工",
				permissions: 'mes:mesengineeringmanagement:workReport',
				src: '../../static/menuIcon/mes_workReport0.svg',
				link: '/pages/workReport/mes_workReport?type=0'
			},
			// {
			// 	title:"组长按包报工",
			// 	permissions: 'mes:mesengineeringmanagement:workGroupReport',
			// 	src: '../../static/menuIcon/mes_workReport1.svg',
			// 	link: '/pages/workReport/mes_workReport?type=1'
			// },
			// {
			// 	title:"报工记录查询",
			// 	permissions: 'mes:mesengineeringmanagement:workGroupReport',
			// 	// permissions: 'mes:mesengineeringmanagement:selectReportRecord',
			// 	src: '../../static/menuIcon/IndividualWorkReportRecord.svg',
			// 	link: '/pages/workReport/workReportRecordQuery',
			// }
		]
	},
	// {
	...
	// 		'mes:mesengineeringmanagement:saveMaterialsReportingPda'
	// 	],
	// 	list: [{
	// 			title: '颜色尺码报工',
	// 			permissions: 'mes:mesengineeringmanagement:saveEngineeringManualPda',
