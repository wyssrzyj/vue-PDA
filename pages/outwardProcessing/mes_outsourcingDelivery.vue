		...
		<view class="pannelContent">
			...
			>
				...
				>
					...
					<!-- <image class="arrowImage" src="../../static/cutWarehouse/leftArrow.png" mode="aspectFit" ></image> -->
					<!-- <image class="arrowImage" src="../../static/cutWarehouse/rightArrow.png" mode="aspectFit" ></image> -->
				</view>
				<view class="touch-list list-delete" v-show="item.isShowScan" @click = "deleteMember(item)">
					删除
				</view>
			</view>
		</view>
	...
	export default{
		...
		methods:{
			...
			handleScanPCS(pcsNum){ // 扫描PCS码
				Api.outScanPCS({
					pcsNum: pcsNum,// "PD20220209023395891-4-00000001",'PD20211110090285439-0-00000116'
