<template>
	<view>
		...
		<view v-if="type==1"><!--绑定微信-->
			<view class="wxbox">
				<view class="weixin"><image src="../../static/outSouring/bind_wx.png"></image></view>
		...
		<view v-else-if="type==2">
			<view class="redbox">
				<image src="../../static/outSouring/hongbao_bg.png"></image>
				<view class="wrapBox">
		...
		<view v-else-if="type==4">
			<view class="updateBox">
				<view class="tubiao"><image src="../../static/outSouring/ic_ar.png"></image></view>
				<view class="wrapbox">
		...
		<view v-else-if="type==5">
			<view class="updateBox1">
				<image src="../../static/outSouring/update_bg.png"></image>
				<view class="wrapBox">
...
<style lang="scss">
	...
	.messBox{
		...
		.btn{
			...
			left: 130rpx;
			width: 432rpx;
			background-color: rgba(23, 148, 209, 1);
			border-radius: 4rpx;
		}
		.close{
			position: absolute;
